...
object LettersBank {
    ...
    val phonicsItems: List<PhonicsItem> = listOf(
        ...
        PhonicsItem('G', "grass", R.drawable.grass),
        ...
        PhonicsItem('R', "red", R.drawable.red1),
    ...
    val blendWords: List<BlendWord> = listOf(
        ...
        BlendWord("rat", image = R.drawable.blend_rat, audio = R.raw.blend_rat),
        BlendWord("dam", image = R.drawable.blend_dam, audio = R.raw.blend_dam),
        ...
        BlendWord("red", image = R.drawable.red1, audio = R.raw.blend_red),
